...
Webflow.require('ix').init([
  {"slug":"zoom","name":"Zoom","value":{"style":{"opacity":0,"scaleX":0.92,"scaleY":0.92,"scaleZ":1},"triggers":[{"type":"load","preload":true,"stepsA":[{"opacity":1,"transition":"transform 600ms ease-out-quart 0ms, opacity 600ms ease-out-quart 0ms","scaleX":1,"scaleY":1,"scaleZ":1}],"stepsB":[]}]}}
]);
